...
const Header: React.FC<{ onLoginClick: () => void; onGetStartedClick: () => void }> = ({
  onLoginClick,
  onGetStartedClick,
}) => (
...
const HeroSection: React.FC<{ onGetStartedClick: () => void }> = ({ onGetStartedClick }) => {
  ...
  const BookIcon = () => (
    <svg
      className="w-24 h-24 text-blue-200/50"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
  ...
  const CapIcon = () => (
    <svg
      className="w-20 h-20 text-blue-200/50"
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
      ...
      />
      <path strokeWidth={1} d="M4.5 19.5h15" />
    </svg>
  );
  const BulbIcon = () => (
    <svg
  ...
  return (
    <section className="relative bg-gradient-to-br from-blue-600 to-indigo-700 text-white h-screen flex flex-col items-center justify-center text-center overflow-hidden pt-24">
      ...
      <div className="absolute top-24 left-10 opacity-50 animate-float-1">
        <BookIcon />
      </div>
      <div className="absolute top-20 right-12 opacity-50 animate-float-2">
        <CapIcon />
      </div>
      <div className="absolute bottom-16 left-24 opacity-50 animate-float-2">
        <BulbIcon />
      </div>
      <div className="absolute bottom-20 right-28 opacity-50 animate-float-1">
        <PlaneIcon />
      </div>
      ...
      <div className="relative z-10 px-4">
        ...
        <p
          className="mt-4 max-w-2xl mx-auto text-lg text-blue-200 animate-fade-in-down"
          style={{ animationDelay: '0.2s' }}
        >
          An AI-powered web application for ACT/SAT preparation, featuring
          AI-generated tests, detailed performance analysis with charts and
          tables, personalized feedback, and an admin dashboard for monitoring
          user progress.
        </p>
        <button
          type="button"
        ...
        <p
          className="mt-6 text-sm text-blue-300 animate-fade-in"
...
const FeaturesSection: React.FC = () => (
  <section id="features" className="py-24 bg-white">
    <div className="container mx-auto px-6 text-center">
      ...
      <p className="text-slate-500 mt-3 mb-16 max-w-xl mx-auto">
        AI-driven features designed for your success.
      </p>
  ...
  <section id="mission" className="py-24 bg-slate-100">
    <div className="container mx-auto px-6 text-center max-w-3xl">
      ...
      <p className="text-slate-500 mt-3 text-lg italic">
        To make learning an adventure, not a chore.
      </p>
      <p className="mt-8 text-slate-600 leading-relaxed">
        Refresh Kid Learning is dedicated to transforming standardized test
        preparation from a daunting task into an engaging, personalized
        adventure. We believe that with the right tools, every student can
        unlock their full potential. Our platform combines the power of
        advanced AI with proven pedagogical strategies to create a learning
        experience that is not only effective but also motivational and fun.
        We&apos;re not just a test-prep company; we&apos;re your partners in
        building a brighter academic future.
      </p>
    </div>
  </section>
);
...
const ContactSection: React.FC = () => (
  <section id="contact" className="py-24 bg-white">
    <div className="container mx-auto px-6 text-center max-w-2xl">
      <h2 className="text-3xl sm:text-4xl font-bold text-slate-8
00">
        Get in Touch
      </h2>
      ...
      <a
        href="mailto:support@refreshkidlearning.com"
